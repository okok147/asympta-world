...
const order: ScenarioDefinition = {
  ...
  agents: [
    ...
    agent("order-receiver", "Ari", "Otter", t("Business receiving agent", "商戶接單 Agent"), t("Acts for the store owner and turns an arrival into a traceable commercial job", "代表店主把到店需要轉成可追蹤商業工作"), art("watercolour", "#7c9185", "#d5b58d"), t("Mori Paper Co.", "Mori Paper Co."), "business"),
  ...
  tasks: [
    ...
    { id: "business-receive", stageId: "business", agentId: "order-receiver", title: t("Business receives the order", "商戶收到訂單"), thought: t("Opening a traceable job", "建立可追蹤工作"), completion: t("OW-1208 received", "OW-1208 已接收"), zone: "communication", durationMs: 1_150, dependencies: ["customer-confirm"], toolId: "order.receive", kind: "specialist" },
    { id: "clarify", stageId: "business", agentId: "order-merchandiser", title: t("Business agents confirm the order", "商戶 Agent 確認訂單"), thought: t("Confirming finish, quantity and promise", "確認表面、數量與承諾"), completion: t("Matte navy · 12 · Friday 17:00 confirmed", "啞面深藍 · 12 · 星期五 17:00 已確認"), zone: "communication", durationMs: 1_100, dependencies: ["business-receive"], toolId: "order.clarify", kind: "specialist" },
    { id: "customer-confirm", stageId: "business", agentId: "order-conductor", title: t("Personal agent finds the store owner", "個人 Agent 找到店主"), thought: t("Walking the request to Mori Paper Co.", "把需要帶到 Mori Paper Co."), completion: t("Owner reached · request handed to business agents", "已找到店主 · 需要交給商戶 Agent"), zone: "communication", durationMs: 850, dependencies: ["interpret"], kind: "specialist" },
